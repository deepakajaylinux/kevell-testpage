...
.. cssclass:: table-bordered
 ...
 +-----------------------------------------+-----------------+------------------------------------------------------------------------+
 |Use existing environment settings? (Y/N) | Y		     | Wenn der Benutzer wünschen, die bestehenden Umgebungseinstellungen zu  |
 |					   | 		     | verwenden, sie können Eingang als Y.				      |
 +-----------------------------------------+-----------------+------------------------------------------------------------------------+
 |Use existing environment settings? (Y/N) | N		     | Wenn der Benutzer nicht wünscht, um die vorhandenen 		      |
 |					   |		     | Umgebungseinstellungen verwenden, können sie Eingang als N.	      |
 +-----------------------------------------+-----------------+------------------------------------------------------------------------+
 |Do you want to add another environment?  | Y		     | Wenn der Benutzer wünschen, eine andere Umgebung hinzufügen, können    |
 |(Y/N)					   | 		     | sie Eingang als Y.						      |
 +-----------------------------------------+-----------------+------------------------------------------------------------------------+
 |Do you want to add another environment?  | N		     | Wenn der Benutzer nicht wünscht, eine andere Umgebung, können sie      |
 |(Y/N)					   | 		     | Eingang als N. hinzufügen.|					      |
 +-----------------------------------------+-----------------+------------------------------------------------------------------------+
...
Wie listet Umwelt configuration
------------------------------------
...
* Dieses Modul führt die Benutzer, wie man die Umgebung zu konfigurieren, wie man die unerwünschten Umgebung zu löschen, wie Sie die 
  Optionsliste verwenden für den verfügbaren Umgebungen
