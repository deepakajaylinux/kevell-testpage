...
Wireframing ist ein wichtiger Schritt in einem beliebigen Bildschirm Design-Prozess. Es ermöglicht in erster Linie Sie die Informationshierarchie Ihres Designs zu definieren, so dass es einfacher für Sie, um das Layout nach, wie Sie Ihren Benutzer der Datenbearbeitung zu wollen planen.
Wireframing ist wichtig, weil es die Designer, um das Layout und Interaktion einer Schnittstelle, ohne von Farben, Schriftbild Entscheidungen oder sogar Kopie abgelenkt zu planen. Ich mag meinen Gästen zu erklären, dass, wenn ein Benutzer kann nicht herausfinden, wo Sie auf einem Schwarz-Weiß-Drahtmodell zu gehen, ist es egal, welche Farben Sie schließlich benutzen. A Taste muss klar sein, auch wenn es keine glänzenden oder hell gefärbt.

Hilfe Befehl
----------------------

Dieser Befehl ermöglicht es Ihnen, Wireframe Sketcher zu installieren, für Wireframing. Der Benutzer wird kommen, um über die verschiedenen Möglichkeiten / Format um dieses Modul ausführen kennen. Dieser Befehl leitet den Anwender, um den Zweck dieses Befehls kennen. Da unten sind die Kommando- und der Screenshot der gleiche.
...
Wenn der Benutzer muss Wireframe Sketcher in Maschine zu installieren. Da unten sind die Befehls- und die Screenshot des Installationsprozesses.
...
.. cssclass:: table-bordered
 ...
 +==========================+=====================================================+============+======================================+
 |ptconfigure               | Eine der beiden alternativen Parameter kann in      | Y          | Sobald der Benutzer bietet die       |
 |WireframeSketcher Install | Befehls verwendet -werdenWireframeSketcher,         |            | Möglichkeit, startet                 |
 |                          | wireframe-sketcher, wireframesketcher               |            | System-Installation                  |
 |                          | eg: ptconfigure wireframe-sketcher Install          |            |                                      |
 +--------------------------+-----------------------------------------------------+------------+--------------------------------------+
 |ptconfigure               | Eine der beiden alternativen Parameter kann in      | N          | Sobald der Benutzer bietet die       | 
 |WireframeSketcher Install | Befehls verwendet -werdenWireframeSketcher,         |            | Möglichkeit, Anschläge               |
 |                          | wireframe-sketcher, wireframesketcher               |            | System-Installation                  |
 |                          | eg: ptconfigure wireframe-sketcher Install|         |            |                                      |
 +--------------------------+-----------------------------------------------------+------------+--------------------------------------+
...
* Der Funktionsumfang verfügbar
* Die relativen Prioritäten der Informationen und Funktionen
* Die Regeln für die Anzeige von bestimmten Arten von Informationen

Die Wirkung der verschiedenen Szenarien auf der Anzeige
