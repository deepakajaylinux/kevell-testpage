...
.. cssclass:: table-bordered
 ...
 +=======================+=================================================+=================+==========================================+
 |ptconfigure Chrome 	 | Eine der beiden alternativen Parameter kann das | Y		     | Sobald der Benutzer die Option bietet, 	|
 |Install? (Y/N)         | Kommando verwendet werden - Chrome , chrome     |		     | startet System-Installation		|
 |			 | eg: ptconfigure chrome Install	           |                 |					        |
 +-----------------------+-------------------------------------------------+-----------------+------------------------------------------+
 |ptconfigure Chrome     | Eine der beiden alternativen Parameter kann das | N               | Sobald der Benutzer die Option bietet,   |
