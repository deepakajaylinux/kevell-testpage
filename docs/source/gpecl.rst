...
Wenn der Benutzer müssen eine pecl installieren, wird die unten angegebenen Befehl den Prozess auszuführen.
...
Wenn der Benutzer braucht, um eine pecl gewährleisten, wird die unten angegebenen Befehl den Prozess auszuführen.

.. code-block:: bash

	ptconfigure peck pkg-ensure
...
Der Befehl verwendet, um die PECL -Paket zu aktualisieren ist unten dargestellt ,
