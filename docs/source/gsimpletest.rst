...
SimpleTest ist eine open-Source-Unit test Framework für die Programmiersprache PHP. Simpletest Framework ermöglicht Komponententests zu schnell tun und Eassily. SimpleTest unterstützt Mockobjekte und dient zur Automatisierung von Regressionstests von Web-Anwendungen mit einem skriptfähigen HTTP-Client, die Analysieren von HTML-Seiten und Dinge wie Links anklicken und Senden von Formularen simulieren können.

Hilfe Befehl
---------------

Dieser Befehl hilft, die Verwendung von Simpletest bestimmen. Alternative Ausgabeparameter von Simpletest aufgelistet. Es beschreibt auch die Syntax für Simpletest-Modul funktionieren. Der Help-Befehl für Simpletest ist angezeigt, wie unten beschrieben.
...
Der Befehl für die Installation von Simpletest-Modul auf dem Terminal ist im folgenden aufgeführt,

.. code-block:: bash

        ptconfigure Simpletest install

Der obige Befehl soll die neueste Version von Xcache und ihre Abhängigkeiten
...
Der Befehl zum Deinstallieren des Simpletest-Moduls auf dem Terminal ist im folgenden aufgeführt,
...
* Macht es einfach, Tests zu trennen und haben sie ausgeführt
* Hilft erleichtern schnelle Testentwicklung
* Notwendig, um Web-Interface testen
* Ermöglicht der Entwickler leicht zu unterscheiden , was falsch ist
