...
Dieses Modul helfen bei der Installation Standardwerkzeuge in dem System. Es kann alle Werkzeuge wie vim zu installieren, zip etc ,. Automation möglich. Es gibt die Standardisierung von Ihrer Umgebung. Es ist benutzerfreundlich mit Ubuntu und Cent-OS.

Hilfe Befehl
---------------------

Hilfe Befehl verwendet werden, um Informationen zu einem bestimmten Befehl zu finden. Weitere Informationen zu den Standardwerkzeugen. können wir diese Hilfe Befehl verwenden.
...
   Als Unternehmen und als Individuen, Standard-Tools widmet sich seitdem der Benutzer Herausforderungen zu begegnen, die Erfüllung ihrer Anforderungen und Erfüllung ihrer Unternehmensziele. Es ist offensichtlich, dass die Verfahren zur Standard-Tools Modul unter ptconfigure installieren, indem einfach mit dem Befehl unten angegeben,
...
Installieren Sie Standardwerkzeugen? (Y / N)

Wenn der Benutzer Wert y

Dann werden alle aktualisierte Standard-Tools installiert.

Wenn der Benutzer Wert als N

Es wird das Fenster zu schließen

Die Screenshots zeigen dies.
...
Im Folgenden sind die alternativen Parameter.

StandardTools, standard-tools, standardtools, std-tools, stdtools.

Vorteile
-------------

* Aktualisierte Version von Installation zur Verfügung.
* Bei bestehenden, kann es zu überschreiben.
